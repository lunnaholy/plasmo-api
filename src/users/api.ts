...
export default class API {
    ...
    getProfile(
        ...
        return new Promise((resolve, reject) => { 
            this.parent.call("user/profile", "GET", { nick: nickname, discord_id: discordId, id, fields })
    ...
    readNotifications(): Promise<APIResponse> {
        return new Promise((resolve, reject) => { 
            this.parent.call("user/notifications", "PATCH")
     ...
     */
     getNotifications(from?: number): Promise<NotificationsAPIResponse> {
        return new Promise((resolve, reject) => { 
            this.parent.call("user/notifications", "GET", { from })
    ...
    auth(token: string): Promise<APIResponse> {
        return new Promise((resolve, reject) => { 
            this.parent.call("user/mc_auth", "GET", { token })
                .then((res: APIResponse) => resolve(res))
                .catch(reject);
        });
    }
